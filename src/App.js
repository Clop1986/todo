...
function App() {
  ...
  const onEditTask = (listId, taskObj) => {    
    ...
    setLists(newList);
    axios
      .patch('/tasks/' + taskObj.id, {text: newTaskText})
      .catch(() => {
      ...
      <div className="todo__tasks">
        <Routes>
          <Route exact path="/" element={
            lists && lists.map(list => (<Tasks key={list.id} list={list} onEditTitle={onEditListTitle} onAddTask={onAddTask} onRemoveTask={onRemoveTask} onEditTask={onEditTask} onCompleteTask={onCompleteTask} withoutEmpty />
          ))} />          
          <Route path="/lists/:id" element={
            lists && activeItem && <Tasks list={activeItem} onEditTitle={onEditListTitle} onAddTask={onAddTask} onRemoveTask={onRemoveTask} onEditTask={onEditTask} onCompleteTask={onCompleteTask} />
          } />           
        </Routes>    
      </div>
    </div>
